...
def main(args):
    ...
    evaluate(model=model, device=device, loss_fxn=eval_loss_fxn, data_loader=test_loader, split='test', classes=test_dataset.CLASSES, history=history, model_dir=model_dir, weights=best_model_wts, plax_weight=args.plax_weight)
